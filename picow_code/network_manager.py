...
class NetworkManager:
    ...
    async def access_point(self, ssid, channel, password):
        if self._ap_if.isconnected():
        ...
        # TODO: Does not seem to be working properly. Look into it
        self._ap_if.ifconfig(("10.10.1.1", "255.255.255.0", "10.10.1.1", "10.10.1.1"))
        self._ap_if.config(ssid=ssid, channel=channel, password=password)
